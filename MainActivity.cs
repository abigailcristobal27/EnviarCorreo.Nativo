...
namespace EnviarCorreo.Nativo
{
    ...
    {
        Button actionButton;
        string emailBase = "tonyaguilar200549@gmail.com";
        ...
        private async void btnReportar_Click(object sender, EventArgs e)
        {
            ...
            if (emailBase == "tonyaguilar200549@gmail.com" || codeBase == "iniciativa")
            {
                

            }
            actionButton.Enabled = false;
            await serviceHelper.InsertarEntidad("tonyaguilar200549@gmail.com", "iniciativa");
